...
public final class Epoll {
    ...
    static  {
        ...
        if (SystemPropertyUtil.getBoolean("io.netty.transport.native.disabled", false)) {
            cause = new UnsupportedOperationException(
                    "Native transport was explicit disabled with -Dio.netty.transport.native.disabled=true");
        } else {
