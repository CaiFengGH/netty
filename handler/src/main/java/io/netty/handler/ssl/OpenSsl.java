...
public final class OpenSsl {
    ...
    static {
        ...
        if (SystemPropertyUtil.getBoolean("io.netty.handler.ssl.openssl.disabled", false)) {
            cause = new UnsupportedOperationException(
                    "OpenSSL was explicit disabled with -Dio.netty.handler.ssl.openssl.disabled=true");
